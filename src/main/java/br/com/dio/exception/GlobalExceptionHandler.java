...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<String> handlerBussinessException(IllegalArgumentException businessException) {
    ...
    public ResponseEntity<String> handlerUnexpectedException(Throwable unexpectedException) {
        var message = "Erro inesperado do servidor, verificar logs";
